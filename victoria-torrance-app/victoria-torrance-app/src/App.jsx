    ...
    return (
      <div style={styles.page}>
        <div style={styles.loginPanel}>
          <img src={logo} alt="Victoria Torrance Bowling Club logo" style={styles.logo} />
          <h1 style={{ marginBottom: 8 }}>Victoria Torrance Bowling Club</h1>
      ...
      <div style={styles.wrap}>
        ...
        {tab === "home" && (
          <div style={styles.panel}>
            ...
            <p>Welcome to the Victoria Torrance Bowling Club app.</p>
